...
$title = 'modification de l\'adhérent n°' . $matriculeAdh;
$gest = 'active';
ob_start();
?>
    ...
    <form action="controleur/c_modifierAdh.php" method="post">
        <div class="form-row">
            <div class="form-group col-md-2">
                ...
                <input type="text" name="matriculeAdh" class="form-control" id="matriculeAdh"
                       value="<?php echo $matriculeAdh ?>">
            </div>
        </div>
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="prenomAdh" id="prenomAdh"
                       value="<?php echo $prenomAdh ?>">
            </div>
        </div>
        <div class="form-row">
            <div class="col">
                <label for="">Adresse</label>
                <input type="text" class="form-control" name="adresseAdh" id="adresseAdh"
                       value="<?php echo $adresseAdh ?>">
            </div>
            <div class="col">
...
<div class="container text-center">
    <br>
    <button class="btn btn-outline-primary" type="submit" value="modifier" name="modifier" id="modifier">modifier
    </button>
    <a href="gestionAdh.php" class="btn btn-outline-secondary">Retour</a>
</div>
</form>
<?php
